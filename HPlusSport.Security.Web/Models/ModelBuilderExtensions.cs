...
public static class ModelBuilderExtensions
{
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        var hashInformtaionBarbara = PasswordHelper.HashPassword("b@rb@r@");
        modelBuilder.Entity<User>().HasData(
            new User { Id = 1, Email = "adam@example.com", Salt = hashInformationAdam.Salt, Hash = hashInformationAdam.Hash },
            new User { Id = 2, Email = "barbara@example.com", Salt = hashInformtaionBarbara.Salt, Hash = hashInformtaionBarbara.Hash }
        );
    }
